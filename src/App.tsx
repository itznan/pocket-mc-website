...
const serverSoftwares = [
  ...
  },
  {
    ...
    description: "High-performance Paper server builds by PaperMC, Minecraft 1.8.8+",
    tag: "Plugins",
  },
  {
    name: "Fabric",
  ...
  },
  {
    ...
    description: "Industry-standard heavyweight modding framework, installer-based setup, Minecraft 1.8.8+",
    tag: "Mods",
  },
  {
    name: "NeoForge",
    icon: "/icons/neoforge.png",
    description: "Community-driven modern Forge fork from Maven metadata, installer-based setup",
    tag: "Mods",
  },
  {
    name: "Bedrock Server (BDS)",
    icon: "/icons/bds.png",
    description: "Community-manifested Windows BDS ZIPs, including release and preview builds",
    tag: "Bedrock",
  },
  {
    name: "PocketMine-MP",
    icon: "/icons/pocketmine-mp.png",
    description: "Extensible PHP-based Bedrock server with managed PHP 8.2 PM5 runtime",
    tag: "PHP",
  },
];
...
const tourTabs = [
  {
    ...
    bullets: [
      ...
      "System tray integration for running in the background",
    ],
  },
  {
    id: "console",
...
const detailFeatures = [
  {
    ...
    description: "WPF instance automation handles everything from creation to crash recovery.",
    items: [
      ...
      "Bedrock listener port patching automatically for Geyser cross-play"
    ]
  },
  {
    id: "ai",
    title: "Intelligent AI Summaries",
    description: "Translate multi-megabyte server logs into quick human-readable session reports.",
    items: [
  ...
  },
  {
    ...
    description: "Windows-focused tools and integrations built for the local desktop environment.",
    items: [
      ...
      "Windows startup, minimize-to-tray, and per-instance auto-start controls",
...
function ScrollAnimationBackground() {
  ...
  useEffect(() => {
    const loadImages = async () => {
      ...
      const successfulLoads = loadedImages.filter(img => img && img.complete && img.naturalWidth > 0).length;
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (scrollY < heroFadeStart) {
        ...
        heroMultiplier = (scrollY - heroFadeStart) / (heroFadeEnd - heroFadeStart);
      }
...
function App() {
  ...
  const activeTabDetails = tourTabs.find(t => t.id === activeTourTab) || tourTabs[0];

  const dockItems = tourTabs.map(tab => {
    const isActive = activeTourTab === tab.id;
    const tabIcon = {
      dashboard: (
        <svg className={`w-5 h-5 transition-colors ${isActive ? 'text-accent' : 'text-main-muted group-hover:text-accent'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
    ...
    return {
      ...
      className: isActive ? '!border-accent !bg-accent/15 scale-110 shadow-lg' : ''
    };
  });
  ...
  return (
    <main className="min-h-screen text-main theme-transition relative overflow-x-clip bg-grid z-0">
      ...
      >
          ...
          <section className="relative mx-auto grid max-w-7xl gap-8 sm:gap-12 lg:gap-16 px-4 sm:px-6 pb-12 sm:pb-20 pt-12 sm:pt-16 lg:grid-cols-[1.1fr_0.9fr] lg:pb-28 lg:pt-24 items-center">
            <div className="relative z-10">
              ...
              <p className="mt-6 sm:mt-8 max-w-xl text-base sm:text-lg leading-7 sm:leading-8 text-main-muted">
                ...
                spins up isolated Bedrock/Java servers, schedules backups, accepts EULAs,
              ...
              <div className="mt-6 sm:mt-8 text-xs text-main-muted font-mono flex items-center gap-2">
                ...
                <span className="line-clamp-2">No administrator rights or global Java installs required.</span>
              </div>
            </div>
            ...
            <div className="relative z-10 lg:pl-4 mt-8 lg:mt-0">
              <div className="relative mx-auto max-w-[520px] lg:max-w-none group">
                ...
                <div className="absolute -top-4 sm:-top-6 -right-2 sm:-right-4 bg-base-card/90 backdrop-blur border border-divider px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg shadow-lg animate-float-slower pointer-events-none text-[9px] sm:text-[10px]">
                  <p className="uppercase font-mono tracking-wider text-main-muted font-bold">Target Platform</p>
                  <p className="font-bold text-xs sm:text-sm text-main mt-0.5">Windows 10 / 11</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <div className="mx-auto grid max-w-7xl gap-8 sm:gap-10 px-4 sm:px-6 py-8 sm:py-12 grid-cols-2 sm:grid-cols-2 md:grid-cols-4">
            {[
              ...
              <div key={label} className="group">
                ...
                <p className="mt-2 text-sm sm:text-lg font-black text-main group-hover:text-accent transition-colors font-mono">{value}</p>
              </div>
            ))}
          </div>
        </section>
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-start mb-4 sm:mb-6">
                    ...
                    <span className="font-mono text-xs font-bold text-main-muted/50">0{idx + 1}</span>
                  </div>
        ...
        <section id="servers" className="relative z-10 border-y border-divider bg-base-muted/20 py-16 sm:py-24">
                  ...
                  <div className="border border-divider bg-base-card rounded-lg sm:rounded-xl overflow-hidden shadow-lg sm:shadow-2xl glow-shadow-accent group relative theme-transition">
                    <div className="h-7 border-b border-divider bg-base-muted/40 px-4 flex items-center justify-between select-none">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[10px] font-mono text-main-muted ml-2">{activeTabDetails.title}</span>
                      </div>
                      <span className="text-[9px] font-mono border border-divider px-1.5 py-0.5 rounded bg-base-muted/20 text-main-muted/80">WPF View</span>
                    </div>
                    ...
                    >
                      ...
                      <div className="absolute bottom-3 right-3 z-20 opacity-0 group-hover/screen:opacity-100 transition-opacity duration-300 bg-base-card/95 backdrop-blur-sm border border-divider px-3 py-1.5 rounded-lg shadow-lg flex items-center gap-2 pointer-events-none select-none">
                        <svg className="w-3.5 h-3.5 text-accent animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v6m3-3H7" />
                        </svg>
                        <span className="text-[10px] font-mono font-bold text-main">Click to view full size</span>
                      </div>
                  ...
                  <div className="flex md:hidden flex-col gap-3 mt-4">
                    ...
                    <div className="flex overflow-x-auto pb-2 gap-2 scrollbar-none snap-x mask-fade-edges px-1">
                      {tourTabs.map((tab) => {
                        ...
                        const tabIcon = {
                          dashboard: (
                            <svg className={`w-3.5 h-3.5 flex-shrink-0 ${isActive ? 'text-accent' : 'text-main-muted'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                              <line x1="18" y1="20" x2="18" y2="10" />
                              <line x1="12" y1="20" x2="12" y2="4" />
                              <line x1="6" y1="20" x2="6" y2="14" />
                            </svg>
                        ...
                        return (
                          <button
                            key={tab.id}
                            onClick={() => setActiveTourTab(tab.id)}
                            className={`flex items-center gap-2 px-3 py-2 rounded-lg border text-xs font-mono font-bold whitespace-nowrap snap-center transition-all cursor-pointer ${isActive
                    ...
                    <div className="flex justify-center gap-2 mt-1">
                      {tourTabs.map((tab) => (
                        <button
                          key={tab.id}
                          onClick={() => setActiveTourTab(tab.id)}
                          className={`h-2 rounded-full transition-all duration-300 cursor-pointer ${activeTourTab === tab.id
                            ? "w-6 bg-accent"
          ...
          <div className="grid gap-8 sm:gap-12 lg:grid-cols-[0.8fr_1.2fr] items-center">
            <div>
              ...
              <BorderGlow
                ...
                glowIntensity={0.8}
                fillOpacity={0.06}
                colors={theme === "dark" ? ['#a78bfa', '#6366f1', '#ec4899'] : ['#4f46e5', '#3b82f6', '#db2777']}
              >
                <div className="p-5 flex gap-4 items-center">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-main">Geyser + Floodgate Provisions</h4>
                    <p className="text-xs text-main-muted mt-1 leading-5">
                      Java server instances can be patched automatically with Geyser dependencies to support Bedrock client joins natively on the same computer.
                    </p>
                  </div>
                </div>
              </BorderGlow>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {isLoading ? (
                ...
                Array.from({ length: 6 }).map((_, i) => (
                  <div key={i} className="p-5 flex gap-4 items-start border border-divider rounded-xl bg-base-card/20 backdrop-blur">
                    ...
                    <div className="p-5 flex gap-4 items-start">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <h3 className="font-bold text-sm text-main">{software.name}</h3>
        ...
        <section id="roadmap" className="relative z-10 border-t border-divider bg-base-muted/30 py-16 sm:py-24 px-4 sm:px-6">
          <div className="mx-auto max-w-4xl">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="mt-4 text-main-muted text-sm">
                We look into real server errors (like locked session files, port clashes, network loopback restrictions, Adoptium hash failures) and fix them behind the scenes.
              </p>
            </div>
            ...
            <div className="space-y-3">
              {isLoading ? (
                ...
                Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="px-6 py-5 border border-divider rounded-xl bg-base-card/20 backdrop-blur">
                ...
                detailFeatures.map((group, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`relative rounded-xl overflow-hidden border transition-all duration-300 ${isOpen
                    ...
                    >
                      ...
                      >
                        <div className="flex gap-4 items-center">
                          ...
                          <motion.div
                            animate={{
                              backgroundColor: isOpen ? "rgba(124,58,237,0.18)" : "rgba(124,58,237,0.08)",
                              borderColor: isOpen ? "rgba(124,58,237,0.45)" : "rgba(124,58,237,0.18)",
                              boxShadow: isOpen ? "0 0 14px -2px rgba(124,58,237,0.45)" : "none",
                            }}
                          ...
                          <div>
                            ...
                            <p className="text-xs text-main-muted mt-1 leading-none">{group.description}</p>
                          </div>
                        </div>
                              ...
                              <div className="space-y-0">
                                {group.items.map((item, i) => (
                                  <motion.div
                                    ...
                                    transition={{ duration: 0.25, delay: i * 0.055, ease: "easeOut" }}
                                    className="flex items-start gap-3 text-xs leading-5 font-mono group/item py-2 border-b border-divider/30 last:border-0"
                                  >
                                    <motion.span
                                      initial={{ scale: 0 }}
                                      animate={{ scale: 1 }}
                                      transition={{ duration: 0.2, delay: i * 0.055 + 0.1, type: "spring", stiffness: 300 }}
              ...
              <>
                ...
                <div className="border border-divider p-8 rounded-xl bg-base-card/20 backdrop-blur">
                  ...
                  <div className="space-y-4">
                    {Array.from({ length: 6 }).map((_, i) => (
                      <div key={i} className="border-b border-divider/60 pb-3 flex flex-col sm:flex-row sm:justify-between gap-1">
                        <Skeleton className="h-4 w-24 rounded" />
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    {[
                      ...
                      <div key={item.step} className="flex gap-4 items-start group">
                        ...
                        <div>
                          <h4 className="font-bold text-sm text-main">{item.title}</h4>
                          <p className="mt-1 text-xs text-main-muted leading-5">{item.desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="flex flex-col justify-between border border-divider p-8 rounded-xl bg-base-card/40 backdrop-blur shadow-sm relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-4 font-mono text-xs">
                      {[
                        ...
                        ["Local Runtimes", ".NET 8 Desktop Runtime (app prompts installer if missing)"],
                        ["Network Details", "Local loopback access helper (CheckNetIsolation) handles BDS player restrictions"],
                        ["Internet Link", "Required for runtime/server downloads, provider metadata, marketplace browsing, updates, and Playit.gg"]
                      ].map(([specName, specVal]) => (
                        <div key={specName} className="border-b border-divider/60 pb-3 flex flex-col sm:flex-row sm:justify-between gap-1">
                          <span className="font-semibold text-main">{specName}</span>
                          <span className="text-main-muted text-left sm:text-right max-w-sm leading-5">{specVal}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="mt-8 p-4 border border-divider bg-base-muted/30 rounded-lg flex items-start gap-3 relative z-10">
                    ...
                    <p className="text-xs text-main-muted leading-5 font-mono">
                      No local global setup needed. PocketMC coordinates app-local Adoptium Java versions and PHP runtimes dynamically.
                    </p>
                  </div>
                </div>
        ...
        <section className="relative z-10 border-t border-divider bg-base-muted/50 py-24 overflow-hidden isolate">
          ...
          <div className="mx-auto max-w-5xl px-6 text-center relative z-10">
            ...
            <p className="mt-6 max-w-xl mx-auto text-base text-main-muted">
              Enjoy full automation, Adoptium managed runtimes, safe scheduled cron backups, Modrinth marketplace installers, and zero port forwarded tunnels.
            </p>
        ...
        <footer className="relative z-10 border-t border-divider px-4 sm:px-6 py-8 sm:py-12 bg-base/50 backdrop-blur-sm">
          <div className="mx-auto flex max-w-7xl flex-col justify-between gap-6 sm:gap-8 text-xs sm:text-sm text-main-muted md:flex-row items-center">
            ...
            <div className="flex gap-3 sm:gap-6 font-mono text-xs flex-wrap justify-center">
              <a href="https://github.com/PocketMC" target="_blank" rel="noreferrer" className="hover:text-accent transition-colors whitespace-nowrap">
                GitHub Organization
              </a>
              <a href="https://discord.gg/h27uNCaxPH" target="_blank" rel="noreferrer" className="hover:text-[#5865F2] transition-colors whitespace-nowrap">
                Discord
              </a>
              <a href="https://www.buymeacoffee.com/sahaj33" target="_blank" rel="noreferrer" className="hover:text-[#FF813F] transition-colors whitespace-nowrap">
                Buy Me a Coffee
              </a>
              <a
                href="https://github.com/PocketMC/pocket-mc-windows"
        ...
        <AnimatePresence>
          {isLightboxOpen && (
            ...
            >
              ...
              >
                <h4 className="font-mono font-bold text-sm tracking-wide text-accent">{activeTabDetails.label}</h4>
                <p className="text-sm text-neutral-300 mt-1">{activeTabDetails.title}</p>
              </motion.div>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <div className="fixed bottom-4 sm:bottom-6 left-4 sm:left-6 z-40 flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
          ...
          >
            <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 fill-current group-hover:rotate-12 transition-transform flex-shrink-0" viewBox="0 0 24 24">
              <path d="M2 21h18v-2H2v2zM20 8h-2V5h2v3zm2-5h-4v7h4V3zm-6 2H4v10c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V5z" />
            </svg>
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
        <a href="#" className="flex items-center gap-2 sm:gap-3 group flex-shrink-0">
          ...
          <div className="hidden sm:block">
            ...
            <p className="mt-1 text-xs text-main-muted font-mono">Local server management</p>
          </div>
        </a>

        <div className="flex items-center gap-4 sm:gap-6">
          <div className="hidden items-center gap-6 sm:gap-8 md:flex mr-2 font-mono text-xs sm:text-sm">
            <a href="#servers" className="font-semibold text-main-muted hover:text-accent transition-colors">
              Servers
            </a>
            <a href="#roadmap" className="font-semibold text-main-muted hover:text-accent transition-colors">
              Under the Hood
            </a>
            <a
              href="https://github.com/PocketMC/pocket-mc-windows"
          ...
          >
            {/* Sun Icon */}
            <svg
              className={`absolute h-5 w-5 transition-all duration-300 transform ${theme === "dark" ? "rotate-90 scale-0 opacity-0" : "rotate-0 scale-100 opacity-100"
                }`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            ...
            {/* Moon Icon */}
            <svg
              className={`absolute h-5 w-5 transition-all duration-300 transform ${theme === "dark" ? "rotate-0 scale-100 opacity-100" : "-rotate-90 scale-0 opacity-0"
                }`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
